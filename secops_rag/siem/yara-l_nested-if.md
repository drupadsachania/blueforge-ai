...
**Scraped:** 2026-03-05T09:33:34.288893Z
...
This example assigns an outcome score based on
principal.hostname
.
...
This example assigns the placeholder IP to
target.ip
or
principal.ip
so long as
they're non-empty. If the IP values are missing, it assigns
no_valid_ip
.
events:
