...
**Scraped:** 2026-03-05T09:32:57.503218Z
...
Google Security Operations
User
view enables customers to better understand how users
...
To open
User
view in Google SecOps, enter the username or email address of
...
username to pivot to
User
view.
User view aliasing
User
view includes a user aliasing feature to ensure events associated with a
...
you search for
dennis
in Google SecOps, events for both
dennis
and
dennis@altostrat.com
are returned.
User view features
User
view includes many features and user interface controls to enable you to
more closely examine the user data within your enterprise. Some of these
features are unique to
User
view and some are shared with the other
...
By default,
User
view centers the Gradient Heat Map at 12:00 UTC (noon). Using
...
4 Gradient heat map
User
view Gradient Heat Map displays an aggregate view of user activity across
...
The
Timeline and Assets
tabs are also available within
User
view. As with
other Google SecOps views, the
Timeline
tab lists events
chronologically and the
Assets
tab lists the assets associated with the user
...
Timeline
tab: Selecting an event in the Timeline tab also highlights
the corresponding event in the Gradient Heat Map in green. Alerts are
indicated by a red triangle and red text.
Asset
tab: Selecting an asset highlights it in green in the Asset tab
...
menu by clicking the Procedural
Filtering icon in
User
view and filter the user information based on a variety
...
Only User, Email, and DNS event types are populated in this view. The first
seen and last seen information populated in this view is also limited
