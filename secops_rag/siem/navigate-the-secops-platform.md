...
**Source:** https://docs.cloud.google.com/chronicle/docs/secops/navigate-the-secops-platform/  
**Scraped:** 2026-03-05T09:14:27.153034Z
...
Supported in:
Google secops
When you access the Google Security Operations platform, your view depends on 
the
permission groups
that you're assigned to. The sliding left navigation bar is customized for you
based on your permissions.
To quickly access documentation directly related to the page you're viewing in 
the platform, click
help
Help
and select
Documentation
.
To navigate around the platform, hold the pointer over the sliding left 
navigation bar and then click to access all of the Google SecOps 
pages.
What do you want to do?
Where can you find it?
Manage all the incoming cases in the platform
Cases
View tailored actions and tasks that you need to complete on cases
Your Workdesk
...
>
Risk Analytics
Design automated sequence of actions to start as soon as the relevant
        alert enters the platform
Response
>
Playbooks
Configure integrations for different instances
Response
>
Integrations Setup
Edit predefined jobs or create new jobs that can be scheduled to run
        periodically
Response
>
Jobs Scheduler
Edit the code of commercial integrations or create custom
        integrations
Response
>
IDE
...
>
SOAR Dashboards
View both predefined Google SecOps SOAR reports and advanced reports using
        Looker
Dashboard and Reports
>
SOAR Reports
Install third-party integrations plus use cases and power ups for the
        platform
Content Hub
Manage administration tasks, ingestion, and parsing configuration for SIEM
Settings
>
SIEM Settings
...
What do you want to do?
Where can you find it?
View details about users and the organization.
Profile
View all the users and groups in the SIEM side of the platform
Users & Groups
View the roles and permissions for the SIEM components of the platform
Roles
Configure and view SIEM feeds
Feeds
Configure and view SIEM forwarders
Forwarders
Manage parsers and parser extensions
Parsers
Share and correlate data from multiple SIEM installations
Linked Instances
Manage which groups can access specific data
Data Access
See which log types are available for use in your organization
Available log types
Connect Workspace and Google SecOps to detect insider risks in your environment
Google Workspace
Set up a Bindplane agent to collect on-premises logs
Collection Agents
Define the rules for calculating risk scores for entities, alerts, and detections
Entity Risk Scores
SOAR Settings
What do you want to do?
Where can you find it?
View all the users in the Google SecOps platform
Organization
>
User Management
Define environments
...
>
Alerts Grouping
Map IdP groups to SOAR user groups, SOC roles and permission groups
Advanced
>
IDP Group Mapping
