...
**Source:** https://docs.cloud.google.com/chronicle/docs/ingestion/default-parsers/trendmicro-vision-one-activity/  
**Scraped:** 2026-03-05T10:01:39.060081Z
...
An
S3 URI
is generated and the data begins to be sent to the corresponding S3 bucket.
Copy and save the S3 URI in a safe location.
(Optional): For Events and Activity data, click
Edit
to modify the scope of the data (Modifying the scope does not change the generated S3 URI).
Set up feeds
...
In the
Feed name
field, enter a name for the feed (for example, Trend Micro Vision One Activity Logs).
Select
Amazon S3 V2
as the
Source type
