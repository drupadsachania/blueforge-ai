...
**Source:** https://docs.cloud.google.com/chronicle/docs/review-alert/  
**Scraped:** 2026-03-05T09:46:08.723322Z
...
An
alert
is an Indicator of Compromise (IOC), flagged by
Google Security Operations
,
...
For more information on YARA-L, see the
...
If the Procedural Filtering menu is not visible, open it by clicking the
Filter
icon
(near the upper right corner).
At the top of the menu, adjust the
Prevalence
slider to filter out common events. Using the Time and Prevalence sliders, to identify suspicious events.
...
The left panel in Asset view shows the Timeline tab. If the event is labeled
Rule Alert
, it will also mention a description of the alert.
Hovering over the
Rule Alert
event causes an
Expand
