...
**Source:** https://docs.cloud.google.com/chronicle/docs/ingestion/default-parsers/trendmicro-ddi/  
**Scraped:** 2026-03-05T10:01:32.670203Z
...
Google secops
SIEM
This document explains how to ingest Trend Micro Deep Discovery Inspector (DDI)
logs to Google Security Operations using Bindplane.
Before you begin
...
: Select
UDP
(or other protocol based on your Bindplane configuration).
Facility
: Enter
Local0
.
