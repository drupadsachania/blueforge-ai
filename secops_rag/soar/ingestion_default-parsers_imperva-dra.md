...
**Source:** https://docs.cloud.google.com/chronicle/docs/ingestion/default-parsers/imperva-dra/  
**Scraped:** 2026-03-05T09:57:15.880048Z
...
Sign in to the
Imperva DRA Management Console
.
Go to
Configuration
>
...
Facility
: Select appropriate syslog facility (for example,
LOCAL0
).
Click
...
Notification Types
: Choose incident open/close/reopen actions and their severity levels.
Message Format
: Select
JSON
for structured data format or
Raw
for basic syslog format.
Configure
Severity Threshold
to determine which severity levels should be forwarded.
