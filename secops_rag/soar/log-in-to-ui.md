...
**Source:** https://docs.cloud.google.com/chronicle/docs/log-in-to-ui/  
**Scraped:** 2026-03-05T09:45:13.134889Z
...
Initiate a search
Initiate a search by entering the domain, email, username, hostname, 
IP address, file hash, or URL into the search bar.
Set the search window
Use the integrated
date
and
time
selector to focus your search on a specific window. Select the required dates and times using the calendar and clock settings dialog.
Need more help?
