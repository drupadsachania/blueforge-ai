...
**Source:** https://docs.cloud.google.com/chronicle/docs/ingestion/default-parsers/onepassword/  
**Scraped:** 2026-03-05T09:58:51.941553Z
...
SecOps GCS Collector - SignIn and ItemUsage
)
Expires After
...
Add principals
: Enter
onepassword-logs-collector-sa@PROJECT_ID.iam.gserviceaccount.com
Assign roles
: Select
Storage Object Admin
Click
...
MAX_RECORDS
10000
Max records per endpoint per run
PAGE_SIZE
1000
...
Value
Name
onepassword-logs-collector-hourly
Region
...
No records returned
: Verify your bearer token has access to the requested event types using the introspect endpoint.
...
1Password Sign-In and Item Usage Logs
).
Select
...
The value is taken from the
client.os_name
field in the raw log and mapped to the corresponding UDM platform value (
LINUX
,
WINDOWS
,
...
N/A
extensions.auth
An empty object is created for this field.
N/A
metadata.event_type
Set to
USER_LOGIN
...
,
STATUS_UPDATE
if no user information is present, and
USER_UNCATEGORIZED
otherwise.
N/A
metadata.log_type
